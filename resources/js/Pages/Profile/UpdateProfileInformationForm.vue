    ...
    <jet-form-section @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="tw-col-span-6 sm:tw-col-span-4">
                ...
                <jet-input id="name" type="text" class="tw-mt-1 block tw-w-full" v-model="form.name" autocomplete="name" />
            ...
            <div class="tw-col-span-6 sm:tw-col-span-4">
                ...
                <jet-input id="email" type="email" class="tw-mt-1 tw-block w-full" v-model="form.email" />
